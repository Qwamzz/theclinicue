...
1. Verify every Must-have functional requirement (FR-01 to FR-58).
...
| TC-U-09 | Tile 08:00-12:00 at 30 min | 8 slots, 08:00 to 11:30 | 8 slots as expected | Pass |
...
|---|---|---|---|
| Identity and access (FR-01 to FR-13) | 13 | 31 auth tests, 26 authorisation tests | All verified |
| Catalogue (FR-14 to FR-19) | 6 | 12 admin and catalogue tests | All verified |
| Slots and booking (FR-20 to FR-32) | 13 | 31 unit + 37 integration tests | All verified |
| Queue (FR-33 to FR-44) | 12 | 27 queue tests, 3 system tests | All verified |
| Admin, audit, reporting (FR-45 to FR-52) | 8 | 34 admin tests | All verified |
| Validation and integrity (FR-53 to FR-58) | 6 | 41 validator tests, 7 injection tests, 3 integrity tests | All verified |
| Performance (NFR-PER-01 to 04) | 4 | Timed harness, 1,000-row dataset | All met |
| Security (NFR-SEC-01 to 06) | 6 | 55 security tests | All met |
| Usability (NFR-USA-01 to 05) | 5 | Instrumented measurement across 7 routes | All met |
| Reliability (NFR-REL-01 to 04) | 4 | Fault injection, transaction, health tests | 3 met; NFR-REL-04 (99% uptime) requires production monitoring |
| Maintainability (NFR-MNT-01 to 06) | 6 | Architecture inspection, 92% coverage, debt register | All met |
