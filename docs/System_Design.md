...
| POST | `/api/auth/register` | public | Patient self-registration | FR-01 … FR-04 |
| POST | `/api/auth/login` | public | Authenticate, issue session + CSRF cookies | FR-05 … FR-08, FR-13 |
...
| GET | `/api/slots` | any | Free slots for practitioner + service + date | FR-20 … FR-23 |
| POST | `/api/appointments` | any | Book (patients for self; staff for anyone) | FR-24 … FR-27, FR-32 |
...
| POST | `/api/queue/check-in` | staff | Check in, issue ticket | FR-34 … FR-37 |
...
| GET/PATCH | `/api/admin/users[/<id>]` | admin | Accounts, roles, activation | FR-45 … FR-47 |
...
| `diagrams/erd.svg` | FR-14 … FR-17, FR-21, FR-27, FR-35, FR-57 |
| `diagrams/class.svg` | FR-43, NFR-MNT-01 |
| `diagrams/sequence_booking.svg` | FR-20 … FR-26, NFR-REL-02 |
| `diagrams/statechart_appointment.svg` | FR-31, FR-36, FR-43 |
| `diagrams/activity_queue.svg` | FR-34 … FR-42 |
| `diagrams/wireframes.svg` | NFR-USA-01 … NFR-USA-05, NFR-LEG-03 |
| §3.2 partial unique indexes | FR-21, FR-26, FR-27, FR-35 |
| §5 security design | FR-04, FR-06 … FR-08, FR-11, FR-12, FR-30, NFR-SEC-01 … 06 |
